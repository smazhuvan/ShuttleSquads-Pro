...
function MetricCard({ icon, title, value, sub }) { return (<div className="bg-white/80 backdrop-blur-xl border border-white p-6 rounded-3xl shadow-lg flex flex-col items-center text-center"><div className="p-4 bg-slate-50 rounded-full mb-4">{icon}</div><p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1" style={{minHeight: "15px"}}>{title}</p><p className="text-xl font-black text-slate-800 break-words leading-tight">{value}</p><p className="text-xs font-bold text-indigo-500 mt-1">{sub}</p></div>); }
